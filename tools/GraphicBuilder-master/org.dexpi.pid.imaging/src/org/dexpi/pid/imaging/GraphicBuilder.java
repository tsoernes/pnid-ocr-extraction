...
public class GraphicBuilder {
	...
	private void addEllipseElement(EllipseElement ellipse) {
		...
		this.gFac.addEllipse(ellipse.getColor(), ellipse.getLineWeight(), ellipse.getLineType(), ellipse.getPosition(),
	...
	private void addCircleElement(CircleElement circleElement) {
		this.gFac.addCircle(circleElement.getColor(), circleElement.getLineWeight(), circleElement.getLineType(),
				circleElement.getPosition(), circleElement.getRadius(), circleElement.getStartAngle(),
				circleElement.getEndAngle(), circleElement.getFilled());
	}
	...
	private void addShapeElement(ShapeElement shapeElement) {
		this.gFac.addShape(shapeElement.getColor(), shapeElement.getLineWeight(), shapeElement.getLineType(),
				shapeElement.getXCoordinates(),	shapeElement.getYCoordinates(), shapeElement.getFilled());
	}
	...
	private void addLineElement(LineElement lineElement) {
		this.gFac.addLine(lineElement.getColor(), lineElement.getLineWeight(), lineElement.getLineType(),
