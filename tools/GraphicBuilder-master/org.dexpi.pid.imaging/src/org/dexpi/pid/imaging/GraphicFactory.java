...
public interface GraphicFactory {
	 ...
	 *            the lineweight
	 * @param lineType
	 *            the line type (dash style) to use for drawing
	 * @param xCoordinates
	 *            the x-coordinates of the line
	 * @param yCoordinates
	 *            the y-coordinates of the line
	 */
	public void addLine(Color c, float lineWeight, LineElement.LineType lineType, double xCoordinates[],
						double yCoordinates[]);
	 ...
	 */
	public void addShape(Color c, float lineWeight, LineElement.LineType lineType, double xCoordinates[],
	 ...
	 */
	public void addCircle(Color c, float lineWeight, LineElement.LineType lineType, double position[],
...
*            the height of the text
	 ...
	 */
	public void addEllipse(Color c, float lineWeight, LineElement.LineType lineType, double[] position,
