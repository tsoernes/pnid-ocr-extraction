...
public class ImageFactory_PNG implements GraphicFactory {
	 ...
	 */
	@Override
	public void addLine(Color c, float lineWeight, DrawableElement.LineType lineType, double[] xCoordinates, double[] yCoordinates) {
	 ...
	 */
	@Override
	public void addShape(Color c, float lineWeight, DrawableElement.LineType lineType, double xCoordinates[], double yCoordinates[], boolean filled) {
	 ...
	 */
	@Override
	public void addEllipse(Color c, float lineWeight, DrawableElement.LineType lineType, double[] position, double primAxis, double secAxis,
	 ...
	 */
	@Override
	public void addCircle(Color c, float lineWeight, DrawableElement.LineType lineType, double[] position, double radius, double startAngle,
